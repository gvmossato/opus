...
urlpatterns = [
    ...
    path('list/task/<int:pk>/update/', views.TaskUpdateView.as_view(), name='task_update'),
    path('list/task/<int:pk>/delete/', views.TaskDeleteView.as_view(), name='task_delete'),
    path('list/tag/<int:pk>/add/',     views.TagAddView.as_view(),    name='tag_add'),      ###
